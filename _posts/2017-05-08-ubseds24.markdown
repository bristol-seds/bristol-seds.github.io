...
photos: [/assets/flights/24/tracker.jpg, /assets/flights/24/tracker_reverse.jpg, /assets/flights/24/cutdown_assembled_front.jpg,
  ...
  /assets/flights/24/cutdown_assy_before_launch.jpg,
  /assets/flights/24/streamer_assy.jpg, /assets/flights/24/assembled_tracker.jpg,
  /assets/flights/24/assembled_panels.jpg]
plots: true
...
[Images](http://ssdv.bristol-seds.co.uk/2017/04/02/ubseds24.html).
...
The balloon achieved a stable altitude of 13.5 km 2.5 hours into the
flight. The free lift was double that used for similar previous
...
The balloon transmits once per minute during launch and when solar
power is available.

### UHF 434.6MHz

It using the error-correcting Contestia 16/1000 mode on 434.635MHz USB.
...
GMSK was used to downlink images within the red area
[on this map](/assets/flights/24/ubseds24_gmsk_rtty.png). The PER was
too high to recover any images.

Outside this area, 300 baud RTTY was used for image downlink. Although
slower, this was more successful. Received by Ron G8FJG.
...
The cutdown is commanded using a FSK signal on the 434MHz ISM band.
...
The streamer is mounted between the cutdown and the tracker. It is 1m
x 0.05m of bright pink ripstop nylon, and is intended to give a
sea-level descent rate of 5m/s. Designed based on results from *On
the Aerodynamic Drag of Streamers and Flags*, A. Carruthers and
A. Filippone. See Figure 11.
