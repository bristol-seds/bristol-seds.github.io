...
description: Custom Envelope to <strike>the Black Sea</strike> <strike>Japan</strike> Iceland
flight:
  countries:
...
pngmap: /assets/flights/13/map.png}
title: UBSEDS13
---
