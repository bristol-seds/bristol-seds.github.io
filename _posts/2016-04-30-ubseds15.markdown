...
flight:
  ...
  - callsign: G8IMN
    data:
      ...
      rxcount: 50
  - callsign: PE1ANS
    data: {max_distance: '396.1', rxcount: 40}
  - callsign: G4YHE
    data:
      country: {isocode: !!python/unicode 'gb', name: !!python/unicode 'United Kingdom'}
      max_distance: '193.2'
...
plots: true
photos: [/assets/flights/15/flying_away_1.jpg,
         /assets/flights/15/flying_away_2.jpg,
         /assets/flights/15/tracker.jpg,
         /assets/flights/15/free_lift.jpg,
         /assets/flights/15/tracker_at_launch.jpg,
